...
<header id="ccr-header">
   <section id="ccr-nav-top" style="display:none;" class="fullwidth">
        <div class="">
            <div class="container">
                <nav class="top-menu">
    ...
    <section id="ccr-site-title" style="display:none;">
        <div class="container">
            <div class="site-logo">
        ...
        <nav class="main-menu">
            <div class="container">
                ...
                <div class="fb-like topfblike" data-href="http://www.facebook.com/ravenFeed" data-layout="button_count"
                     ...
                     class="fb-like fb_iframe_widget" data-send="false" fb-xfbml-state="rendered" style="margin-top: 10px";></div>
