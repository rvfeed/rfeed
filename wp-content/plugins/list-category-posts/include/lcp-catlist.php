    ...
    if ( !empty($this->params['excerpt']) && $this->params['excerpt']=='yes'){         
      ...
      if( strlen($lcp_excerpt) < 1 ){
        $lcp_excerpt = $single->post_title;
             ...
             $href =    get_permalink($single->ID);
       $lcp_excerpt =  "<div class='lcp_cat_list'><span class='lcp_list_title'>"
                        ."<a href='" .$href ."'>".$single->post_title."</a></span><br>"
                        .$lcp_excerpt." <a  href='" . $href . "'><span class='read-more'>Read More</span></a></div>";
      return $lcp_excerpt;
    }
  }
